...
"""
Run a Phase-field simulation using openphase (academic)
"""
...
with ImportAlarm(
    "For running openphase via pyiron, install the openphase pathon package."
) as openphase_alarm:
    from openphase import Result, YAML, ConfigMaterial
...
__version__ = "1.0"
__maintainer__ = "Marian Bruns"
__email__ = "m.bruns@mpie.de"
