...
latex_documents = [
  ('index', 'pyiron_continuum.tex', u'pyiron_continuum Documentation',
...
man_pages = [
    ('index',
     'pyiron_continuum',
     u'pyiron_continuum Documentation',
...
main(['-e', '-o', 'apidoc', '../pyiron_continuum', '--force'])
